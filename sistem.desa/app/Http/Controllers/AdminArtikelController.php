<?php namespace App\Http\Controllers;
	...
	class AdminArtikelController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Paragraf","name"=>"paragraf"];
			...
			$this->form[] = ['label'=>'Paragraf','name'=>'paragraf','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Isi','name'=>'isi','type'=>'textarea','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Paragraf","name"=>"paragraf","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
